...
const Terms = () => {
  return <div className="container-width py-8 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none space-y-8 mt-8">
          ...
          <TermsSection title="3. Description of the Service">
            ...
            <TermsList items={["Recording home improvement projects", "Uploading receipts, photos, and other supporting documents", "Calculating and tracking cost basis for tax reporting", "Exporting data for tax forms such as IRS Form 8949", "Optional tools for maintenance tracking and personalized recommendations"]} />
          </TermsSection>

          <TermsSection title="4. User Accounts">
            <TermsList items={["Account Creation: To use certain features of our Service, you must create an account and provide accurate and complete information.", "Account Security: You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to notify us immediately of any unauthorized use of your account.", "Eligibility: You must be at least 18 years old and capable of entering into a legally binding agreement to use the Service."]} />
          </TermsSection>

          <TermsSection title="5. User Obligations">
            <p>You agree to use the Service in compliance with all applicable laws and not to:</p>
            <TermsList items={["Violate or infringe the rights of others", "Use the Service for any fraudulent or unlawful purpose", "Interfere with or disrupt the operation of the Service", "Upload or share any content that is illegal, harmful, or otherwise objectionable"]} />
          </TermsSection>

          <TermsSection title="6. Prohibited Conduct">
            <p>You agree not to:</p>
            <TermsList items={["Reverse engineer, decompile, or disassemble any part of the Service", "Use automated scripts or other means to access the Service in a manner that violates these Terms", "Share your account credentials with third parties"]} />
          </TermsSection>

          <TermsSection title="7. Intellectual Property">
            <TermsList items={["Our Property: All content, features, and functionality of the Service, including text, graphics, logos, images, and software, are owned by PropertyTracker or its licensors and are protected by intellectual property laws.", "User Content: You retain ownership of any content you upload or submit. By submitting content, you grant us a non-exclusive, worldwide, royalty-free license to use, display, and distribute your content in connection with the Service.", "Restrictions: You agree not to reproduce, duplicate, copy, sell, or exploit any portion of the Service without express written permission."]} />
          </TermsSection>
          ...
          <TermsSection title="8. Disclaimer of Warranties">
            ...
            <TermsList items={["Merchantability", "Fitness for a particular purpose", "Non-infringement"]} />
          ...
          <TermsSection title="13. Contact Information">
            ...
            <p>myrenovationreceipts@gmail.com</p>
          </TermsSection>
        </div>
      </div>
    </div>;
