...
export const HowItWorks = () => {
  return <div className="section-padding bg-gray-50">
      <div className="container-width">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold sm:text-4xl mb-4">
            How We Help
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Streamline home improvement tracking, maximize tax benefits, and maintain organized records for your peace of mind.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-12">
          {steps.map((step, index) => <div key={index} className="relative">
              {index < steps.length - 1 && <div className="hidden md:block absolute top-8 left-full w-full h-0.5 bg-blue-200 -z-10" />}
