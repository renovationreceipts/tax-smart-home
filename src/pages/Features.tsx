...
const Features = () => {
  return <div className="min-h-screen bg-white">
      <div className="container-width py-8 sm:py-12 px-[28px]">
        <div className="mb-8">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {detailedFeatures.map((feature, index) => <div key={index} className="bg-white p-6 rounded-lg shadow-sm border">
